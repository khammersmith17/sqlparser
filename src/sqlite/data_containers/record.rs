...
use crate::data_containers::schema::{IndexMetadata, IndexRowRef};
use crate::utils::{parse_sqlite_varint, parse_varint, traverse_record, SqliteVarint};
...
impl TableRecord {
    pub fn new(
        ...
        for (value, col_name) in value_sizes.into_iter().zip(col_names) {
            ...
            row_values.insert(col_name.to_uppercase(), record_v);
        }
        Ok(TableRecord {
            record_id,
            row_values,
